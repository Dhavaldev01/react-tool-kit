            ...
            <div className='p-6 lg:max-w-7xl max-w-4xl mx-auto'>
                <div className='grid items-center grid-cols-1 lg:grid-cols-5 gap-12 shadow-sm p-6'>
                    ...
                    <div className='lg:col-span-2'>
                        <h2 className='text-2xl font-extrabold text-[#33333333333]'>{productDetails?.title}</h2>
                    ...
                    <div>
                        ...
                        className='disabled: opacity-60 mt-5 min-w-[200px] px-4 py-3 border border-[#333] bg-transparent text-sm font-semibold rounded'>Add to Card</button>
                    </div>
                    </div>
