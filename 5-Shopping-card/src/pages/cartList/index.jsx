    ...
    <div className="grid md:grid-cols-3 gap-8 mt-12">
      <div className="md:col-span-2 space-y-4">
        ...
        <div className="mt-5 flex gap-2 ">
          ...
          className="disabled:opacity-65 text-sm px-4 py-3 bg-black text-white font-extrabold">Checkout</button>
          <button 
          onClick={()=> navigate("/products")}
          className="text-sm px-4 py-3 bg-black text-white font-extrabold" >Continue Shopping</button>
